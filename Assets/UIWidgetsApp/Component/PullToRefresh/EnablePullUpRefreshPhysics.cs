...
{
    public class EnablePullUpRefreshScrollPhysics : ScrollPhysics
    {
        public EnablePullUpRefreshScrollPhysics(
        ...
        {
            return new EnablePullUpRefreshScrollPhysics(buildParent(ancestor: ancestor),
